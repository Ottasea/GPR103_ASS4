...
public class GameManager : MonoBehaviour
{
    ...
    public Text scoreText; // Visual representation of the score on screen.
    ...
    public void HealthSystem() //Displays the visual representation for the lives dictated by the player script.
    {
    ...
    public void GameTimer() //Controls the timer which counts down from 30, player dies at 0 and then timer resets if game is still playing
    {
